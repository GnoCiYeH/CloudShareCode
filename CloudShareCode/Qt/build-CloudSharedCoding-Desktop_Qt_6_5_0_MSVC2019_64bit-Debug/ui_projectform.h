...
public:
    ...
    void setupUi(QWidget *ProjectForm)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/qss/flatblack/branch_open.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/qss_icons/light/rc/arrow_up_disabled.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 809, 457));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 789, 437));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 809, 457));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 789, 437));
    ...
    void retranslateUi(QWidget *ProjectForm)
    {
        ...
        pushButton_9->setText(QCoreApplication::translate("ProjectForm", "\346\213\211\345\217\226\350\207\263\346\234\254\345\234\260", nullptr));
        ...
        pushButton_8->setText(QCoreApplication::translate("ProjectForm", "\346\213\211\345\217\226\350\207\263\346\234\254\345\234\260", nullptr));
