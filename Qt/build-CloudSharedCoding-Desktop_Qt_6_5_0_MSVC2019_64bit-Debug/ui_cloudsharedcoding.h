...
public:
    ...
    void setupUi(QWidget *CloudSharedCoding)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/qss_icons/dark/rc/window_minimize_disabled.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/qss_icons/dark/rc/window_undock_disabled@2x.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/qss_icons/dark/rc/window_close_disabled@2x.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QWidget *CloudSharedCoding)
    {
        ...
        label->setText(QCoreApplication::translate("CloudSharedCoding", "CloudSharedCoding", nullptr));
