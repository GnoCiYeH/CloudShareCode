...
#include "../../CloudSharedCoding/codeedit.h"
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSEditWorkThreadENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSEditWorkThreadENDCLASS = QtMocHelpers::stringData(
    "EditWorkThread",
    "deleteInfo",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSEditWorkThreadENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSEditWorkThreadENDCLASS_t qt_meta_stringdata_CLASSEditWorkThreadENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "EditWorkThread"
        QT_MOC_LITERAL(15, 10),  // "deleteInfo"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "EditWorkThread",
    "deleteInfo",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEditWorkThreadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject EditWorkThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_CLASSEditWorkThreadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEditWorkThreadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEditWorkThreadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<EditWorkThread, std::true_type>,
        // method 'deleteInfo'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>
...
void EditWorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditWorkThread *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->deleteInfo((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
...
const QMetaObject *EditWorkThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *EditWorkThread::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEditWorkThreadENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}

int EditWorkThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
